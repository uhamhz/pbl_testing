...
<body>
    <nav>
        ...
        <div class="nav-links">
            <a href="/app/views/detail/asc.html" class="back-button">Kembali</a>
        </div>
    </nav>
    <div class="container">
        ...
        <iframe src="/public/form/formulirAsc.pdf" width="100%" height="500px"></iframe>

        <!-- Tombol download -->
        <div class="text-center">
            <a href="/public/form/formulirAsc.pdf" class="cta-button" download>Download Formulir PDF</a>
        </div>
    </div>
